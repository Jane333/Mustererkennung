...
eq2        = 0.1;          % error quality

while abs(sum(e2)) > eq2
...
alpha      = 0.04;         % learning rate
eq4        = 0.1;          % error quality

while abs(sum(e4)) > eq4
for runs = 1:length(ATD)
...
alpha      = 0.04;         % learning rate
eq8        = 0.1;          % error quality

while abs(sum(e8)) > eq8
for runs = 1:length(ATD)
...
alpha      = 0.04;         % learning rate
eq10       = 0.1;          % error quality

while abs(sum(e10)) > eq10
for runs = 1:length(ATD)
